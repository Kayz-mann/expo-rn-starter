...
const Button: FC<Props> = ({
    ...
    return (
        <Box style={{
            borderColor: addErrorBorder ? theme.colors.error : addErrorBorder ? theme.colors.error : 'none',
            borderWidth: addErrorBorder ? 1 : 0,
            borderRadius: 8
        }}>
            <Box style={{
                borderColor: addBorder ? theme.colors.bg : addErrorBorder ? theme.colors.error : 'none',
                ...
                <TouchableOpacity
                    ...
                    style={[
                        styles.container,
                        {
                            ...
                            borderRadius: radius ? 25 : 8,
                            borderWidth: type === 'secondary' ? 1 : 0,
                            borderColor: type === 'secondary' ? theme.colors.primary : type === 'secondaryAlert' ? theme.colors.primary : 'bg',
                            shadowColor: type === 'primary' ? theme.colors.primary : type === 'alert' ? theme.colors.primary : 'none',
                ...
                >
                    {loading ? (
                        <ActivityIndicator
                            color={type === 'primary' ? theme.colors.bg : theme.colors.primary}
                        />
                    ) : (
